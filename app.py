...
MERMA_GOTEO_LITROS_POR_LLENADO = 0.006  # 6 ml por botellón llenado; modela gotas, no pérdida completa de 7 L.
...
class EmbotelladoraAsIsGUI:
        ...
        while env.now < TIEMPO_SIMULACION and self.simulacion_activa:
            ...
            try:
                self.cola_mensajes_gui.put_nowait(("STATS", (
                    ...
                    self.botellas_defectuosas_inicio, f"{self.mermas_agua:.2f}",
    ...
    def flujo_botella(self, env, id_b):
        ...
        with self.res_llenado.request() as req:
            ...
            self.mermas_agua += MERMA_GOTEO_LITROS_POR_LLENADO
