...
# -----------------------------------------
# Sidebar: Login de Admin + Botón de guardado
# -----------------------------------------
with st.sidebar.expander("ADMIN (LOGIN)", expanded=True):
    ...
    if not st.session_state.is_admin:
        ...
        if st.button("💾 Guardar apuestas"):
            ...
            st.success("¡Apuestas guardadas en la base de datos!")
...
if st.session_state.is_admin:
    with st.container():
        ...
        # Actualizamos sólo en sesión; para persistir, pulsar “Guardar apuestas”
